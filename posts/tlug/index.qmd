...
certain cockiness, a hint of arrogance that normal people could build someething cool.
Three decades ago, a young group of TLUGers ignored convention and started companies
and projects. We changed the world. In 2026, people are still working on amazing things
and trying to fix the problems of the world.

![Well into the night of beer and food](bigger-group.png)

At every sip (or gulp) of beer, it felt like things were about to take off.

Some of the interesting topics in 2026 thrown about as the beer flowed.
...
- How to create and maintain one of the world most widely  used Linux distributions in the world. Contribute
  to societal good, have fun, and get paid to help the world in 2026.
- Linguistic theory impact on AI
- Graph theory in the pharmaceutical industry
- Bayesian inference versus language models

![Build, create and build some more](jim-stephen-cliff-bryan.png)
...
is what keeps us together.  Despite the obvious problems with potential negative
