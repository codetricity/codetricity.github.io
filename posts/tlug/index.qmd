...
After the 2nd 大ジョッキ (large beer mug), the nostalgic tales of the past
...
![Simon, an exchange student looking for a problem to solve](simon.png)
...
contributed to the warm feeling about the future.  But much more than
that, I was reminded that the connection between people is the engine to make an impact on the world.
...
![Alberto Tomita, network security expert. computer vision PhD. Beer drinker](alberto.png)

---

The US media portrays change as a conflict where one side wins and one side loses.
At a friendly beer hall in Japan, I was reminded that real change comes
from helping strangers, people different from you.
Innovation and change comes from small exchanges of different ideas,
one person in our vast world at a time.
